...
const LogoMeta = () => (
	<svg viewBox="0 0 24 24" className="h-6 w-6 shrink-0" xmlns="http://www.w3.org/2000/svg">
		<path d="M16.3 6.1c-1.3 0-2.5.5-3.5 1.4-.4.4-.8.8-1.1 1.3-.3-.5-.7-.9-1.1-1.3-1-1-2.2-1.4-3.5-1.4-2.8 0-5.1 2.3-5.1 5.1s2.3 5.1 5.1 5.1c1.3 0 2.5-.5 3.5-1.4.4-.4.8-.8 1.1-1.3.3.5.7.9 1.1 1.3 1 1 2.2 1.4 3.5 1.4 2.8 0 5.1-2.3 5.1-5.1s-2.3-5.1-5.1-5.1zm-9.2 8.2c-1.7 0-3.1-1.4-3.1-3.1s1.4-3.1 3.1-3.1c.8 0 1.5.3 2.1.9.3.3.5.6.7.9-.2.3-.4.6-.7.9-.6.6-1.3.9-2.1.9zm9.2 0c-.8 0-1.5-.3-2.1-.9-.3-.3-.5-.6-.7-.9.2-.3.4-.6.7-.9.6-.6 1.3-.9 2.1-.9 1.7 0 3.1 1.4 3.1 3.1s-1.4 3.1-3.1 3.1z" fill="#0668E1"/>
	</svg>
);
