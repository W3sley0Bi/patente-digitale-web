			...
			<main className="max-w-5xl mx-auto p-8">
				<header className="mb-8">
					...
					<p className="text-ink-muted">
						Manage incoming driving school claims.
					</p>
				</header>
					...
					<div className="bg-white rounded-xl border border-line overflow-hidden">
						<table className="w-full text-left text-sm">
							<thead className="bg-bg border-b border-line">
								<tr>
									<th className="px-6 py-4 font-semibold uppercase tracking-wider text-xs text-ink-muted">
										School
									</th>
									<th className="px-6 py-4 font-semibold uppercase tracking-wider text-xs text-ink-muted">
										Contact
									...
									<th className="px-6 py-4 text-right font-semibold uppercase tracking-wider text-xs text-ink-muted">
										Actions
									</th>
								</tr>
							</thead>
